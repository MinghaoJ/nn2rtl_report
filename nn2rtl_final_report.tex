...
\lstset{
    frame=single,
    basicstyle=\fontspec{Menlo}\footnotesize,
    tabsize=4,
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/shared_multiplier}
